        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8">
            ...
            <p className="text-sm text-gray-600 mt-2">
              Please read these Terms of Service carefully before using OutAudits.
            </p>
          </div>
          ...
          <section id="acceptance">
            ...
            <p>
              By accessing and using OutAudits ("Service", "Platform", "we", "us", or "our"), you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service.
            </p>
          </section>
          ...
          <section id="use-license">
            ...
            <p>
              Permission is granted to temporarily download one copy of the materials (information or software) on OutAudits for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:
            </p>
            <ul className="list-disc list-inside space-y-2 mt-4 ml-4">
              <li>Modify or copy the materials</li>
              <li>Use the materials for any commercial purpose or for any public display (commercial or non-commercial)</li>
              <li>Attempt to decompile or reverse engineer any software contained on OutAudits</li>
          ...
          <section id="service-description">
            ...
            <p>
              OutAudits provides website auditing, analysis, and reporting tools powered by Google Lighthouse and other industry-standard metrics. Our Service includes:
            </p>
            <ul className="list-disc list-inside space-y-2 mt-4 ml-4">
          ...
          <section id="intellectual-property">
            ...
            <p>
              Unless otherwise stated, OutAudits and/or its licensor own the intellectual property rights for all material on the Service. All intellectual property rights are reserved. You may view and print pages from the Service for personal use, subject to restrictions set in these terms and conditions.
            </p>
            <p className="mt-4">
              You must not:
            </p>
            <ul className="list-disc list-inside space-y-2 mt-4 ml-4">
              <li>Republish material from OutAudits</li>
              <li>Sell, rent, or sub-license material from OutAudits</li>
              <li>Reproduce, duplicate, or copy material from this Site for commercial purposes</li>
              <li>Redistribute content from OutAudits unless content is specifically made for redistribution</li>
            </ul>
          </section>
          ...
          <section id="user-content">
            ...
            <p>
              In these Website Standard Terms and Conditions, "User Content" shall mean any audio, video, text, images, or other material you choose to display on this Service. By displaying User Content, you grant OutAudits a non-exclusive, worldwide, irrevocable license to:
            </p>
            <ul className="list-disc list-inside space-y-2 mt-4 ml-4">
            ...
            <p className="mt-4">
              This license includes the right to display User Content on OutAudits and use it for promotional purposes. OutAudits has the right but not the obligation to refuse, remove, or edit any User Content.
            </p>
          </section>
          ...
          <section id="disclaimer">
            ...
            <p>
              The materials on OutAudits are provided on an 'as is' basis. OutAudits makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties including, without limitation, implied warranties or conditions of merchantability, fitness for a particular purpose, or non-infringement of intellectual property or other violation of rights.
            </p>
            <p className="mt-4">
              Further, OutAudits does not warrant or make any representations concerning the accuracy, likely results, or reliability of the use of the materials on its Internet web site or otherwise relating to such materials or on any sites linked to this site.
            </p>
            <p className="mt-4">
          ...
          <section id="limitation-liability">
            ...
            <p>
              In no event shall OutAudits or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption,) arising out of the use or inability to use the materials on OutAudits, even if OutAudits or a OutAudits authorized representative has been notified orally or in writing of the possibility of such damage.
            </p>
            <p className="mt-4">
          ...
          <section id="indemnification">
            ...
            <p>
              You agree to indemnify and hold harmless OutAudits and its parent, subsidiaries, affiliates, officers, directors, agents, and employees from and against any and all claims, liabilities, damages, losses, or expense arising out of:
            </p>
            <ul className="list-disc list-inside space-y-2 mt-4 ml-4">
          ...
          <section id="modifications">
            ...
            <p>
              OutAudits may revise these Terms of Service at any time without notice. By using the Service, you are agreeing to be bound by the then current version of these Terms of Service.
            </p>
            <p className="mt-4">
          ...
          <section id="contact">
            ...
            <div className="bg-gray-100 rounded-lg p-6 mt-4">
              <p><strong>OutAudits</strong></p>
              <p className="mt-2">Email: legal@outaudits.com</p>
              <p>Website: www.outaudits.com</p>
            </div>
          </section>
        </div>
