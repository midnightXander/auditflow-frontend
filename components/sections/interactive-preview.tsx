          ...
          <div className="relative flex justify-center items-center h-[540px] sm:h-[520px] md:h-[480px]">
            {reportSamples.map((sample, index) => {
              ...
              return (
                <div
                  key={sample.title}
                  className={`absolute top-1/2 left-1/2  max-w-full -translate-y-15 rounded-xl border border-white/20 bg-white/10 backdrop-blur-md p-4 shadow-2xl shadow-slate-950/40 transition-all duration-700 ease-out ${
